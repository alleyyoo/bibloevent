            ...
            <div class="col-4">
                <div class="border-left pl-4">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="banner-tab" data-toggle="tab" href="#banner-tab-content" role="tab" aria-controls="banner-tab-content" aria-selected="false">
                                <span class="font-weight-bold font-italic">Banner Görseli</span>
                            </a>
                        </li>
                        <li class="nav-item">
                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="banner-tab-content" role="tabpanel" aria-labelledby="banner-tab">
                            @component('admin.components.form.fileselect', [
                                'name' => 'banner',
                                'model' => $page,
                            ])@endcomponent
