            ...
            <div class="col-4">
                <div class="border-left pl-4">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" id="video-tab" data-toggle="tab" href="#video-tab-content" role="tab" aria-controls="video-tab-content" aria-selected="false">
                                <span class="font-weight-bold font-italic">Video</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="tab-pane fade" id="video-tab-content" role="tabpanel" aria-labelledby="video-tab">
