            ...
            <div class="col-4">
                <div class="border-left pl-4">
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="cover-tab" data-toggle="tab" href="#cover-tab-content" role="tab" aria-controls="cover-tab-content" aria-selected="true">
                                <span class="font-weight-bold font-italic">Kapak Fotoğrafı</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="media-tab" data-toggle="tab" href="#media-tab-content"
                               role="tab" aria-controls="media-tab-content" aria-selected="true">
                                <span class="font-weight-bold font-italic">Medya</span>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="gallery-tab" data-toggle="tab" href="#gallery-tab-content"
                               role="tab" aria-controls="gallery-tab-content" aria-selected="false">
                                <span class="font-weight-bold font-italic">Galeri</span>
                            </a>
                        </li>
                    </ul>
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane fade show active" id="cover-tab-content" role="tabpanel" aria-labelledby="cover-tab">
                            @component('admin.components.form.fileselect', [
                                'name' => 'cover',
                                'model' => $page,
                            ])@endcomponent
                        </div>
                        <div class="tab-pane fade show" id="media-tab-content" role="tabpanel"
                        ...
                        <div class="tab-pane fade" id="gallery-tab-content" role="tabpanel"
